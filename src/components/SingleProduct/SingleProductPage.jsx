...
import useData from '../../hooks/useData'; // Assuming you have a custom hook for fetching data
...
const SingleProductPage = () => {
    ...
    const { addToCart } = useContext(CartContext); // Assuming you have a CartContext to manage cart state
